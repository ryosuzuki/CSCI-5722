...
disp('Start computing built-in disparity map');
defaultDisparityMap = disparity(frameLeftGray, frameRightGray);
disp('Start computing SSD disparity map with window size of 1');
ssdDisparityMap1 = ssd(frameLeftGray, frameRightGray, 1, disparityRange);
disp('Start computing SSD disparity map with window size of 3');
ssdDisparityMap3 = ssd(frameLeftGray, frameRightGray, 3, disparityRange);
disp('Start computing SSD disparity map with window size of 5');
ssdDisparityMap5 = ssd(frameLeftGray, frameRightGray, 5, disparityRange);

disp('Finish calculation');
figure;
subplot(2, 2, 1);
imshow(defaultDisparityMap, disparityRange);
title('Built-in Disparity Map');
colormap jet
colorbar

subplot(2, 2, 2);
imshow(ssdDisparityMap1, disparityRange);
title('SSD Disparity Map with Window Size of 1');
colormap jet
colorbar

subplot(2, 2, 3);
imshow(ssdDisparityMap3, disparityRange);
title('SSD Disparity Map with Window Size of 3');
colormap jet
colorbar

subplot(2, 2, 4);
imshow(ssdDisparityMap5, disparityRange);
title('SSD Disparity Map with Window Size of 5');
colormap jet
colorbar



disp('Start computing NCC disparity map with window size of 3');
nccDisparityMap3 = ncc(frameLeftGray, frameRightGray, 3, disparityRange);
disp('Start computing NCC disparity map with window size of 5');
nccDisparityMap5 = ncc(frameLeftGray, frameRightGray, 5, disparityRange);
disp('Start computing NCC disparity map with window size of 7');
nccDisparityMap7 = ncc(frameLeftGray, frameRightGray, 7, disparityRange);
...
subplot(2, 2, 2);
imshow(nccDisparityMap3, disparityRange);
title('NCC Disparity Map with Window Size of 1');
colormap jet
colorbar

subplot(2, 2, 3);
imshow(nccDisparityMap5, disparityRange);
title('NCC Disparity Map with Window Size of 3');
colormap jet
colorbar

subplot(2, 2, 4);
imshow(nccDisparityMap7, disparityRange);
title('NCC Disparity Map with Window Size of 5');
colormap jet
colorbar
...
disp('Start computing Left-Right SSD disparity map with window size of 3');
ssd_LR = ssd(frameLeftGray, frameRightGray, 3, disparityRange);
disp('Start computing Right-Left SSD disparity map with window size of 3');
ssd_RL = ssd(frameRightGray, frameLeftGray, 3, disparityRange);
disp('Start computing consistency check');
ssdBinaryMap = check(ssd_LR, ssd_RL, threshold);

disp('Start computing Left-Right NCC disparity map with window size of 3');
ncc_LR = ncc(frameLeftGray, frameRightGray, 3, disparityRange);
disp('Start computing Right-Left NCC disparity map with window size of 3');
ncc_RL = ncc(frameRightGray, frameLeftGray, 3, disparityRange);
disp('Start computing consistency check');
nccBinaryMap = check(ncc_LR, ncc_RL, threshold);

disp('Finish calculation');
figure;
subplot(1, 2, 1)
imshow(ssdBinaryMap, disparityRange);
title('SSD Disparity Map');

subplot(1, 2, 2)
imshow(nccBinaryMap, disparityRange);
title('NCC Disparity Map');


disparityMap = ssdDisparityMap3;
